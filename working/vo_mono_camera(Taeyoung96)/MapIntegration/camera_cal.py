...
# MARGIN_X_OF_OBJECT_IMAGE, MARGIN_Y_OF_OBJECT_IMAGE = 136, 100
...
def get_camera_matrices():
    ...
    if ret:
        ...
        with open(os.path.join(Cal_img_path, 'camera_matrices.p'), 'wb') as f:
...
def loadCamera_Matrices(camera_file_path=os.path.join(Cal_img_path, 'camera_matrices.p')):
