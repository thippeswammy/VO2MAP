...
data_params.path1 = '../../../data/kitti-odom/09/image_0/';
data_params.path2 = '../../../data/kitti-odom/09/image_1/';

% Path to calibration text file
data_params.calib_file = '../../../data/kitti-odom/09/calib.txt';

% Path to groundtruth poses. Set flag to 1 to plot groundtruth as well
data_params.gt_file = '../../../data/kitti-odom/09/00.txt';
