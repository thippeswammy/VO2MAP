...
'''
python eval_odom.py --result result/example_1 --align 7dof --seqs 9

python KittiEvalOdom.py --result results --seq 9 --method_files tseting/v1.txt tseting/v2.txt --align scale
'''
